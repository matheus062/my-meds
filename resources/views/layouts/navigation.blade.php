<nav x-data="{ open: false }" class="bg-[#10223F] border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-gray-800 ">
                    ...
                    <x-nav-link :href="route('lembrete.create')">
                        {{ __('+ Lembrete') }}
                    </x-nav-link>
                    @if (Auth::user()->paciente)
                    <x-nav-link :href="route('patient.index')" :active="request()->routeIs('paciente')">
                        {{ __('Paciente') }}
                    </x-nav-link>
                    @endif
                    @if(Auth::user()->farmaceutico)
